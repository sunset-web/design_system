...
<div class="perso-data">
    <div class="perso-data__content">
        <div class="perso-data__header">
            <h2 class="perso-data__title">
                <a href="<?= ($arParams['USER_PROFILE_LINK'] ? $arParams['USER_PROFILE_LINK'] : '/crm/') ?>"><?= GetMessage('PERSONAL_INFO_TITLE'); ?></a>
            </h2>
            <a href="<?= ($arParams['USER_PROFILE_LINK'] ? $arParams['USER_PROFILE_LINK'] : '/crm/') ?>" class="perso-data__button">
        ...
        <div class="perso-data__info">
            ...
            <div class="perso-data__body">
                ...
                <div class="perso-data__link"><?= $arResult["USER"]["EMAIL"]; ?></div>
            </div>
        </div>
    </div>
</div>